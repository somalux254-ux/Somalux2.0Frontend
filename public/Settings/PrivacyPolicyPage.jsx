      ...
      <div style={{ padding: 16, paddingTop: 12, width: '100%', maxWidth: '100%', boxSizing: 'border-box' }}>
        <div style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
          ...
          <section style={{ marginBottom: 16, padding: 14, borderRadius: 12, background: 'var(--bg-surface)', border: '1px solid var(--border-muted)' }}>
            ...
            <p>We collect personal information you provide when you create an account, use our services, or communicate with us. This may include your name, email address, phone number, profile details, and any content you share on Joblink.</p>
          ...
          <section style={{ marginBottom: 16, padding: 14, borderRadius: 12, background: 'var(--bg-surface)', border: '1px solid var(--border-muted)' }}>
            ...
            <p>Joblink does not sell your personal data. We may share information with service providers, payment processors, and partners to operate the service, deliver support, or comply with legal obligations.</p>
          ...
          <section style={{ marginBottom: 16, padding: 14, borderRadius: 12, background: 'var(--bg-surface)', border: '1px solid var(--border-muted)' }}>
            <h4>7. Contact</h4>
            <p>If you have privacy questions or requests, please contact Joblink support through the app or website.</p>
          </section>
        </div>
      </div>
    </div>
