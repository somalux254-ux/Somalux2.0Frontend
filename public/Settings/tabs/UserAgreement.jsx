      ...
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, width: '100vw', height: '100vh', maxWidth: '100%', background: 'var(--bg-primary)', zIndex: 1200, display: 'flex', flexDirection: 'column', margin: 0, padding: 0, color: 'var(--text-primary)', overflowX: 'hidden' }}>
        ...
        <div style={{ overflowY: 'auto', overflowX: 'hidden', padding: 16, paddingTop: 0, width: '100%', maxWidth: '100%', boxSizing: 'border-box', paddingBottom: 'max(8px, env(safe-area-inset-bottom))', background: 'var(--bg-primary)' }}>
          <div className="agreement-text" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
            <h3>{pageTitle === 'Privacy Policy' ? 'Joblink Privacy Policy' : 'Joblink Terms of Use'}</h3>
            ...
            <section style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              {openSectionId === 'introduction' && (
                <div style={{ marginTop: 12 }}>
                  <p>
                    Welcome to Joblink. This Joblink Terms of Use ("Agreement") is a binding legal agreement between you and Excellent Innovation Limited ("Joblink", "we", "us", or "our") governing your access to and use of Joblink's products, services, and software.
                  </p>
                  <p>
                    By using Joblink, you confirm that you have read, understood, and accepted this Agreement. If you do not agree, do not use Joblink.
                  </p>
                </div>
              )}
            </section>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>1.1</strong> "Service" means the Joblink platform and all related functionality, including the mobile application, website, APIs, software, tools, and services.
              </p>
            <p>
            ...
            <p>
              <strong>1.4</strong> "Employer" means any User posting roles, reviewing candidates, or using Joblink’s hiring or recruitment features.
            </p>
            <p>
            ...
            <p>
              <strong>1.9</strong> Joblink may change this Agreement at any time. If we make material changes, we will notify you through the app, email, or other available communication channels.
            </p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>2.1</strong> By clicking "Agree" or by using Joblink, you accept this Agreement and agree to comply with it.
              </p>
            <p>
            ...
            <p>
              <strong>2.3</strong> Minors may use Joblink only with parental or guardian consent and only where permitted by law.
            </p>
            <p>
              <strong>2.4</strong> Joblink may refuse access or suspend accounts that are ineligible, provide false information, or violate this Agreement.
            </p>
            ...
            <p>
              <strong>3.4</strong> Notify Joblink immediately if you suspect unauthorized access, loss, or theft of your credentials.
            </p>
            <p>
              <strong>3.5</strong> Joblink may suspend, disable, or terminate accounts that use false information, violate this Agreement, or appear compromised.
            </p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>4.1</strong> Joblink supports multiple User roles, including Job Seekers, Employers, Recruiters, and Service Providers. You must use the Service in accordance with the role you have selected.
              </p>
            <p>
              <strong>4.2</strong> You agree not to use Joblink for abusive, discriminatory, harassing, fraudulent, or unlawful conduct.
            </p>
            <p>
            ...
            <p>
              <strong>4.4</strong> You are responsible for observing recruitment, tax, labor, and data privacy laws applicable to your activities on Joblink.
            </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>5.1</strong> You retain ownership of your User Content. By submitting User Content, you grant Joblink a worldwide, royalty-free, non-exclusive, sublicensable license to use, reproduce, modify, distribute, and display it as necessary to provide the Service.
              </p>
              <p>
                <strong>5.2</strong> You warrant that your User Content is true, accurate, and does not infringe any third-party rights.
              </p>
              <p>
                <strong>5.3</strong> Joblink may remove, reject, or edit User Content that violates this Agreement, is unlawful, or poses a risk to the Service.
              </p>
              <p>
                <strong>5.4</strong> Joblink and its licensors retain all rights, title, and interest in the Service and its original content, including trademarks, software, designs, and documentation.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <ul>
                ...
                <li><strong>6.1.4</strong> interfere with the Service, introduce malware, or disrupt Joblink systems;</li>
                <li><strong>6.1.5</strong> use bots, scrapers, or other automated methods to access or extract data from Joblink without permission;</li>
                <li><strong>6.1.6</strong> reverse engineer, decompile, or attempt to derive source code or algorithms from Joblink;</li>
                <li><strong>6.1.7</strong> violate any applicable law, regulation, or Joblink policy.</li>
              </ul>
              <p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>7.1</strong> Joblink is a platform that facilitates connections between job seekers, employers, recruiters, and service providers.
              </p>
              <p>
                <strong>7.2</strong> Joblink is not an employer, staffing agency, or agent. Joblink does not hire or employ any User and is not responsible for employment decisions, compensation, or contractual arrangements.
              </p>
              <p>
                <strong>7.3</strong> Joblink does not guarantee any particular outcome, including interviews, offers, hires, or payments.
              </p>
              <p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>8.3</strong> Unless otherwise required by applicable law, fees are non-refundable. Refunds are handled according to Joblink’s refund policy.
              </p>
              <p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>9.2</strong> Joblink may modify or terminate promotional offers at any time.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>10.1</strong> Joblink may integrate with third-party tools, services, and content, including payment processors, analytics providers, and verification services.
              </p>
              <p>
                <strong>10.2</strong> Third-party services are governed by their own terms and privacy practices. Joblink is not responsible for their performance or content.
              </p>
              <p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>11.1</strong> Joblink’s Privacy Policy explains how we collect, use, disclose, and retain personal data. It is incorporated into this Agreement.
              </p>
              <p>
              ...
              <p>
                <strong>11.4</strong> Joblink may retain data as required by law, dispute resolution, or to protect our rights and the rights of others.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>12.1</strong> Joblink may request permission to access device features such as camera, microphone, contacts, storage, and location.
              </p>
              <p>
                <strong>12.2</strong> Granting permissions is optional, but declining optional permissions may reduce functionality.
              </p>
              <p>
                <strong>12.3</strong> Joblink may send service messages, account updates, and alerts. You may manage marketing preferences where available.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>13.1</strong> Joblink employs commercially reasonable security measures, but cannot guarantee absolute protection.
              </p>
              <p>
              ...
              <p>
                <strong>13.3</strong> Report security incidents or suspicious activity to Joblink promptly.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>14.1</strong> Joblink may collect usage, performance, and diagnostic data to operate and improve the Service.
              </p>
              <p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>15.1</strong> Joblink may update, suspend, or discontinue the Service, or any feature, at any time without liability.
              </p>
              <p>
                <strong>15.2</strong> Joblink is not responsible for outages, delays, or degradation caused by third parties, infrastructure failure, or events outside our control.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>16.1</strong> Joblink may offer beta features or early access programs. These features may be incomplete and are provided at Joblink’s discretion.
              </p>
              <p>
                <strong>16.2</strong> Feedback you provide may be used by Joblink without compensation.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>17.2</strong> Do not use Joblink from prohibited jurisdictions or for purposes that violate trade restrictions.
              </p>
              <p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                Joblink may investigate suspicious activity, block fraudulent accounts, and cooperate with law enforcement where required.
              </p>
              <p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>19.1</strong> Joblink may suspend or terminate your access if you breach this Agreement, violate policies, or create risks for the Service.
              </p>
              <p>
                <strong>19.2</strong> Upon termination, Joblink may delete or restrict access to your account and User Content in accordance with data retention policies.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>20.1</strong> The Service is provided "as is" and "as available." Joblink disclaims all warranties, express or implied, including merchantability and fitness for a particular purpose.
              </p>
              <p>
                <strong>20.2</strong> Joblink does not warrant that the Service will be uninterrupted, secure, or error-free.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>21.1</strong> To the fullest extent permitted by law, Joblink is not liable for indirect, incidental, special, punitive, or consequential damages.
              </p>
              <p>
                <strong>21.2</strong> Joblink’s aggregate liability for any claim arising from the Service is limited to the amount you paid to Joblink in the prior twelve months, or one hundred dollars (USD 100), whichever is less.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                You agree to indemnify and hold Joblink harmless from claims, losses, liabilities, damages, and expenses arising from your use of the Service, User Content, or breach of this Agreement.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>23.2</strong> You and Joblink agree to resolve disputes through the dispute resolution process identified by Joblink or as required by law.
              </p>
              <p>
                <strong>23.3</strong> If legal action is necessary, it shall be brought in the applicable court specified by Joblink, except where prohibited by law.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                <strong>24.1</strong> Joblink may provide notices by email, push notification, or in-app message. You agree that electronic communications satisfy any legal notice requirement.
              </p>
              <p>
            ...
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                This Agreement constitutes the entire agreement between you and Joblink regarding the Service, superseding prior agreements.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                Joblink may assign this Agreement to affiliates or successors without notice, provided the assignee agrees to bound by these terms.
              </p>
            </details>
            <details style={{ marginBottom: 6, border: '1px solid var(--border-muted)', borderRadius: 12, padding: 10, background: 'var(--bg-surface)' }}>
              ...
              <p>
                For questions, support, or data rights requests, use Joblink’s Help or Feedback features or contact our support channels listed in the app.
              </p>
            </details>
      ...
      <div className="section-header" style={{ cursor: 'default' }}>
        <div>
          ...
          <p className="settings-stp-page-section-description">
            {isFullPage ? 'Last updated: June, 2026' : (isExpanded ? 'Click Collapse to hide' : 'Last updated: June, 2026 — Use the button below to read the full agreement')}
          </p>
          {!isFullPage && (
            <button
              type="button"
      ...
      {isExpanded && (
        ...
        >
          <div className="agreement-text" style={{}}>
            <h3>Joblink Terms Summary</h3>
            <p><strong>Last updated:</strong> June 24, 2026</p>
            <p>This summary highlights the key obligations for using Joblink. The full agreement above offers complete details for account security, content rules, privacy, fees, third-party services, and legal protections.</p>
            <p><strong>Key points:</strong></p>
            <ul>
              <li>Your Joblink account is personal and you are responsible for all activity under it.</li>
              <li>Joblink is a platform connecting users; it does not guarantee employment or hiring outcomes.</li>
              <li>You must submit accurate, lawful user content and comply with Joblink’s conduct rules.</li>
              <li>Paid features and third-party integrations are governed by separate terms and disclosures.</li>
              <li>Using Joblink means you accept privacy, intellectual property, and limitation of liability terms.</li>
            </ul>
