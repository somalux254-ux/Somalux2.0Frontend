...
export const FaqTab = ({ onBack }) => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: 'Use the Contact Support option and choose "Enterprise Sales" or email sales@somalux.example for dedicated assistance.'
    },
    {
      id: 13,
    ...
    },
    {
      ...
      answer: 'Yes, you can message recruiters and employers through Somalux. Go to Messages or click on a recruiter\'s profile to start a conversation.'
    },
    {
      id: 17,
