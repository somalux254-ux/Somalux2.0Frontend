...
const usageSections = [
  {
    ...
    content: [
      'Treat every Somalux user with respect, courtesy, and professionalism, whether you are posting a role, responding to an application, or sending a message.',
  ...
  },
  {
    ...
    content: [
      ...
      'Do not use Somalux to solicit payment outside the platform, collect personal financial information without consent, or direct users to unsafe third-party sites.',
  ...
  },
  {
    ...
    content: [
      ...
      'Respect privacy by not sharing contact details, financial information, or personal data without explicit consent and by using Somalux messaging when required.',
    ],
  },
  {
    id: 'privacy-data',
    ...
    content: [
      ...
      'Respect Somalux privacy settings and profile preferences; do not attempt to bypass restrictions or extract information that has not been shared publicly.',
    ],
  },
  {
    ...
    content: [
      'Protect your login credentials and never share your password, authentication tokens, or device access with anyone, even if the request appears to come from Somalux.',
      'Report suspicious account activity, unauthorized access, or security incidents immediately through Somalux support channels.',
      'Somalux may suspend or terminate accounts that engage in account sharing, fraud, unauthorized access, or any activity that puts the platform or users at risk.',
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      "If you observe behavior that violates this Usage Policy, report it immediately through Somalux's reporting tools so the team can investigate and act.",
      'Somalux reviews all reports and may take actions including warnings, content removal, temporary suspension, or permanent account termination.',
      'Cooperating with investigations and providing truthful information helps Somalux maintain a safe, fair, and trusted community for everyone.',
    ],
  },
  {
    ...
    content: [
      'You must comply with all applicable laws, regulations, and Somalux policies while using the platform, including labor rules, anti-discrimination requirements, and data protection obligations.',
      'Violations of this Usage Policy may result in warnings, restricted functionality, account suspension, or permanent removal from Somalux.',
      'Somalux reserves the right to investigate suspected abuse, cooperate with law enforcement, and take legal action if necessary to protect users and the platform.',
    ],
  },
  {
    id: 'support-appeals',
    ...
    content: [
      'If you need help or believe an action was taken in error, contact Somalux support with clear evidence and a description of the issue.',
      'Somalux will provide dispute or appeal guidance where appropriate, but retains final authority over membership, content, and enforcement decisions.',
      ...
      <div className="settings-usage-policy-page" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, width: '100vw', height: '100vh', maxWidth: '100%', background: 'var(--bg-primary)', zIndex: 1200, display: 'flex', flexDirection: 'column', margin: 0, padding: 0, color: 'var(--text-primary)', overflowX: 'hidden' }}>
        ...
        <div style={{ flex: 1, padding: 16, paddingTop: 0, width: '100%', maxWidth: '100%', boxSizing: 'border-box', background: 'var(--bg-primary)', overflowY: 'auto', overflowX: 'hidden' }}>
          <div className="agreement-text" style={{ wordBreak: 'break-word', overflowWrap: 'break-word', minHeight: '100%', paddingBottom: 29 }}>
            <h3>Somalux Usage Policy</h3>
            <p><strong>Last updated:</strong> September 3, 2026</p>
            <p>This Usage Policy defines the behavior, content, and safety expectations for every person using Somalux. It is designed to protect users, preserve trust, and keep the platform professional and reliable.</p>
      ...
      <div className="section-header" style={{ cursor: 'default' }}>
        <div>
          ...
          <p className="settings-stp-page-section-description">
            {isFullPage ? 'Last updated: September 3, 2026' : (isExpanded ? 'Click Collapse to hide' : 'Last updated: September 3, 2026 - Use the button below to read the full usage policy')}
          </p>
          {!isFullPage && (
            <button
              type="button"
      ...
      {isExpanded && (
        ...
        >
          <div className="agreement-text" style={{}}>
            <h3>Somalux Usage Policy Summary</h3>
            <p><strong>Last updated:</strong> September 3, 2026</p>
            <p>The Somalux Usage Policy helps ensure every member can search, apply, hire, and communicate in a trustworthy environment. This policy covers conduct, posting quality, privacy, security, and enforcement.</p>
            ...
            <ul>
              ...
              <li>Protect your account and follow Somalux's security policies.</li>
            </ul>
            ...
            <ul>
              ...
              <li>Respect Somalux's reporting and enforcement processes.</li>
            </ul>
          </div>
        </div>
      )}
