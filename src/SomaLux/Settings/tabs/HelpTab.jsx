      ...
      <div className="settings-stp-options-group help-page-options-group">
        <div className="help-page-option-row">
          <div className="help-page-option-info">
            ...
            <p className="option-description">Browse our FAQ section with answers to common questions about using Somalux</p>
          </div>
          <button
        ...
        <div className="help-page-option-row">
          <div className="help-page-option-info">
            ...
            <p className="option-description">Access comprehensive guides, tutorials, and documentation about all Somalux features</p>
          </div>
          <button
            onClick={() => handleOpenLink('https://somalux.co.ke/docs')}
            className="help-page-action-button"
          >
        ...
        <div className="help-page-option-row">
          <div className="help-page-option-info">
            ...
            <p className="option-description">Join our active community, share experiences, and get help from other Somalux users</p>
          </div>
          <button
            onClick={() => handleOpenLink('https://community.somalux.co.ke')}
            className="help-page-action-button"
          >
        ...
        <div className="help-page-option-row">
          <div className="help-page-option-info">
            ...
            <p className="option-description">Check the status of Somalux services and view any ongoing maintenance or incidents</p>
          </div>
          <button
            onClick={() => handleOpenLink('https://status.somalux.co.ke')}
            className="help-page-action-button"
          >
